        ...
        <div className="Mujer-Container-Dashboard-All">
          <div className="Mujer-Container-Dashboard">
            ...
            <div className="Mujer-Container-Dashboard-Posts">
              <Post imagen={'https://app.cuidadoconelperro.com.mx/media/catalog/product/1/_/1_7415.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} imagenHover={'https://app.cuidadoconelperro.com.mx/media/catalog/product/2/_/2_7402.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} articulo="Playera Manga Corta Básica Estampado AC/DC" 
              precio={149.00} color="GRIS" />
              <Post imagen={'https://app.cuidadoconelperro.com.mx/media/catalog/product/2/_/2_6457.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} imagenHover={'https://app.cuidadoconelperro.com.mx/media/catalog/product/5/_/5_944.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} articulo="Playera Manga Corta Básica Estampado AC/DC" 
              precio={149.00} color="GRIS" />
            ...
            <div className={`collapse ${isCollapsed ? 'hide' : ''}`} id="collapseExample">
              <div className="card card-body">
                <div className="ArreglarBootstrap-Container">
                  ...
                  <div className="ArreglarBootstrap">
                    <Post imagen={'https://app.cuidadoconelperro.com.mx/media/catalog/product/1/_/1_7426.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} imagenHover={'https://app.cuidadoconelperro.com.mx/media/catalog/product/2/_/2_7413.jpg?width=1480&optimize=low&bg-color=255,255,255&fit=bounds 1480w, https://app.cuidadoconelperro.com.mx/media/catalog/product/2/_/2_7413.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} articulo="Playera Manga Corta Básica Estampado AC/DC" 
                    precio={149.00} color="GRIS" />
                  </div>
                  <div className="ArreglarBootstrap">
                    <Post imagen={'https://app.cuidadoconelperro.com.mx/media/catalog/product/1/_/1_6139.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} imagenHover={'https://app.cuidadoconelperro.com.mx/media/catalog/product/2/_/2_6124.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} articulo="Playera Manga Corta Básica Estampado AC/DC" 
                    precio={149.00} color="GRIS" />
                  </div>
                  <div className="ArreglarBootstrap">
                    <Post imagen={'https://app.cuidadoconelperro.com.mx/media/catalog/product/1/_/1_6139.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} imagenHover={'https://app.cuidadoconelperro.com.mx/media/catalog/product/2/_/2_6124.jpg?width=1920&optimize=low&bg-color=255,255,255&fit=bounds'} articulo="Playera Manga Corta Básica Estampado AC/DC" 
